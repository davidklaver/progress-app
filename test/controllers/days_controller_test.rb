...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { date: @day.date, learning: @day.learning, maariv: @day.maariv, mincha: @day.mincha, shacharis: @day.shacharis } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { date: @day.date, learning: @day.learning, maariv: @day.maariv, mincha: @day.mincha, shacharis: @day.shacharis } }
